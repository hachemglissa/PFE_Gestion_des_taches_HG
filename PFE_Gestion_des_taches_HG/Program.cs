...
using PFE_Gestion_des_taches_HG.Services.Implementation;
...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
    options.UseSqlServer("server=LAPTOP-327JDN3K;Database=Gestion_des_taches;Trusted_Connection=True;TrustServerCertificate=True;")
);

// Register TokenService dependency
builder.Services.AddScoped<TokenService, TokenService>();
// Register your service with the DI container
builder.Services.AddScoped<ITacheService, TachesService>();
